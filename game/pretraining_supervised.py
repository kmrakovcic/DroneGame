...
def train_pretrained_models(player_x, player_y, drone_x, drone_y, epochs=10, batch_size=1024, drone_path=None,
    ...
    player_model.compile(optimizer=tf.keras.optimizers.SGD(learning_rate=0.1), loss='mse')
    drone_model.compile(optimizer=tf.keras.optimizers.SGD(learning_rate=0.1), loss='mse')
